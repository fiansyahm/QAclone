                    ...
                    <div class="card radius-10 shadow-none bg-light-success mb-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                <div class="">
                                    <p class="mb-1 text-success">Total User</p>
                                    <h4 class="mb-0 text-success">{{ $total_user }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card radius-10 shadow-none bg-light-primary mb-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                <div class="">
                                    <p class="mb-1 text-primary">Total Project</p>
                                    <h4 class="mb-0 text-primary">{{ $total_project }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card radius-10 shadow-none bg-light-warning mb-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                <div class="">
                                    <p class="mb-1 text-warning">Article Assessed</p>
                                    <h4 class="mb-0 text-warning">{{ $article_assessed }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        var not_assign = {!! json_encode($article_not_assign) !!};
